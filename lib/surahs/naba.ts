...
import { Naba } from '../types/islam';

export const naba: Naba = {
  ayah_1: {
    image: '',
    text: 'About what are they asking one another?',
    verse: 5542,
  },
  ayah_2: { image: '', text: 'About the great news -', verse: 5543 },
  ayah_3: {
    image: '',
    text: 'That over which they are in disagreement.',
    verse: 5544,
  },
  ayah_4: { image: '', text: 'No! They are going to know.', verse: 5545 },
  ayah_5: { image: '', text: 'Then, no! They are going to know.', verse: 5546 },
  ayah_6: {
    image: '',
    text: 'Have We not made the earth a resting place?',
    verse: 5547,
  },
  ayah_7: { image: '', text: 'And the mountains as stakes?', verse: 5548 },
  ayah_8: { image: '', text: 'And We created you in pairs', verse: 5549 },
  ayah_9: {
    image: '',
    text: 'And made your sleep [a means for] rest',
    verse: 5550,
  },
  ayah_10: { image: '', text: 'And made the night as clothing', verse: 5551 },
  ayah_11: { image: '', text: 'And made the day for livelihood', verse: 5552 },
  ayah_12: {
    image: '',
  ...
  ayah_16: { image: '', text: 'And gardens of entwined growth.', verse: 5557 },
  ayah_17: {
    image: '',
  ...
  ayah_26: { image: '', text: 'An appropriate recompense.', verse: 5567 },
  ayah_27: {
    image: '',
  ...
  ayah_32: { image: '', text: 'Gardens and grapevines', verse: 5573 },
  ayah_33: {
    image: '',
    text: 'And full-breasted [companions] of equal age',
    verse: 5574,
  },
  ayah_34: { image: '', text: 'And a full cup.', verse: 5575 },
  ayah_35: {
    image: '',
