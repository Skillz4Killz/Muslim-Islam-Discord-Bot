...
import { Haj } from '../typings/islam';

export const haj: Haj = {
	ayah_1: {
    text: 'O mankind, fear your Lord. Indeed, the convulsion of the [final] Hour is a terrible thing.',
    image: '',
    verse: 2465,
 },
 ayah_2: {
 ...
 ayah_4: {
    text: 'It has been decreed for every devil that whoever turns to him -  he will misguide him and will lead him to the punishment of the Blaze.',
    image: '',
    verse: 2468,
 },
 ayah_5: {
    text: 'O People, if you should be in doubt about the Resurrection, then [consider that] indeed, We created you from dust, then from a sperm-drop, then from a clinging clot, and then from a lump of flesh, formed and unformed -  that We may show you. And We settle in the wombs whom We will for a specified term, then We bring you out as a child, and then [We develop you] that you may reach your [time of] maturity. And among you is he who is taken in [early] death, and among you is he who is returned to the most decrepit [old] age so that he knows, after [once having] knowledge, nothing. And you see the earth barren, but when We send down upon it rain, it quivers and swells and grows [something] of every beautiful kind.',
    image: '',
    verse: 2469,
 },
 ayah_6: {
 ...
 ayah_13: {
    text: 'He invokes one whose harm is closer than his benefit -  how wretched the protector and how wretched the associate.',
    image: '',
    verse: 2477,
 },
 ayah_14: {
 ...
 ayah_19: {
    text: 'These are two adversaries who have disputed over their Lord. But those who disbelieved will have cut out for them garments of fire. Poured upon their heads will be scalding water',
    image: '',
    verse: 2483,
 },
 ayah_20: {
    text: 'By which is melted that within their bellies and [their] skins.',
    image: '',
    verse: 2484,
 },
 ayah_21: {
    text: 'And for [striking] them are maces of iron.',
    image: '',
    verse: 2485,
 },
 ayah_22: {
    text: 'Every time they want to get out of Hellfire from anguish, they will be returned to it, and [it will be said], "Taste the punishment of the Burning Fire!"',
    image: '',
    verse: 2486,
 },
 ayah_23: {
 ...
 ayah_24: {
    text: 'And they had been guided [in worldly life] to good speech, and they were guided to the path of the Praiseworthy.',
    image: '',
    verse: 2488,
 },
 ayah_25: {
 ...
 ayah_26: {
    text: 'And [mention, O Muhammad], when We designated for Abraham the site of the House, [saying], "Do not associate anything with Me and purify My House for those who perform Tawaf and those who stand [in prayer] and those who bow and prostrate.',
    image: '',
    verse: 2490,
 },
 ayah_27: {
    text: 'And proclaim to the people the Hajj [pilgrimage]; they will come to you on foot and on every lean camel; they will come from every distant pass -',
    image: '',
    verse: 2491,
 },
 ayah_28: {
 ...
 ayah_29: {
    text: 'Then let them end their untidiness and fulfill their vows and perform Tawaf around the ancient House."',
    image: '',
    verse: 2493,
 },
 ayah_30: {
 ...
 ayah_33: {
    text: 'For you the animals marked for sacrifice are benefits for a specified term; then their place of sacrifice is at the ancient House.',
    image: '',
    verse: 2497,
 },
 ayah_34: {
 ...
 ayah_42: {
    text: "And if they deny you, [O Muhammad] -  so, before them, did the people of Noah and 'Aad and Thamud deny [their prophets],",
    image: '',
    verse: 2506,
 },
 ayah_43: {
 ...
 ayah_44: {
    text: 'And the inhabitants of Madyan. And Moses was denied, so I prolonged enjoyment for the disbelievers; then I seized them, and how [terrible] was My reproach.',
    image: '',
    verse: 2508,
 },
 ayah_45: {
 ...
 ayah_46: {
    text: 'So have they not traveled through the earth and have hearts by which to reason and ears by which to hear? For indeed, it is not eyes that are blinded, but blinded are the hearts which are within the breasts.',
    image: '',
    verse: 2510,
 },
 ayah_47: {
 ...
 ayah_48: {
    text: 'And for how many a city did I prolong enjoyment while it was committing wrong. Then I seized it, and to Me is the [final] destination.',
    image: '',
    verse: 2512,
 },
 ayah_49: {
    text: 'Say, "O people, I am only to you a clear warner."',
    image: '',
    verse: 2513,
 },
 ayah_50: {
 ...
 ayah_51: {
    text: 'But the ones who strove against Our verses, [seeking] to cause failure -  those are the companions of Hellfire.',
    image: '',
    verse: 2515,
 },
 ayah_52: {
 ...
 ayah_53: {
    text: '[That is] so He may make what Satan throws in a trial for those within whose hearts is disease and those hard of heart. And indeed, the wrongdoers are in extreme dissension.',
    image: '',
    verse: 2517,
 },
 ayah_54: {
 ...
 ayah_55: {
    text: 'But those who disbelieve will not cease to be in doubt of it until the Hour comes upon them unexpectedly or there comes to them the punishment of a barren Day.',
    image: '',
    verse: 2519,
 },
 ayah_56: {
 ...
 ayah_57: {
    text: 'And they who disbelieved and denied Our signs -  for those there will be a humiliating punishment.',
    image: '',
    verse: 2521,
 },
 ayah_58: {
 ...
 ayah_66: {
    text: 'And He is the one who gave you life; then He causes you to die and then will [again] give you life. Indeed, mankind is ungrateful.',
    image: '',
    verse: 2530,
 },
 ayah_67: {
    text: 'For every religion We have appointed rites which they perform. So, [O Muhammad], let the disbelievers not contend with you over the matter but invite them to your Lord. Indeed, you are upon straight guidance.',
    image: '',
    verse: 2531,
 },
 ayah_68: {
 ...
 ayah_77: {
    text: 'O you who have believed, bow and prostrate and worship your Lord and do good -  that you may succeed.',
    image: '',
    verse: 2541,
 },
 ayah_78: {
