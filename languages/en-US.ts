...
export default class extends Language {
  language = {
    ...
    AYAH_SURAH_AND_AYAH: (surah, ayah) =>
    ...
    REMIND_NOT_SETUP: 'The reminder channel has not been setup for this guild by a guild admin. Please ask a guild admin to use the **!setup reminder** command before I can send reminders.',
  };
}
